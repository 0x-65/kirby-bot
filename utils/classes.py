...
class Emojis:
    ...
    success: str = "<:success:1095048642219475034>"
    error: str = "<:error:1095048637773512745>"
    warning: str = "<:warning:1095048645751099452>"
    loading: str = "<a:loading:938545251105243147>"
    database: str = "<:database:1095049885939679412>"
